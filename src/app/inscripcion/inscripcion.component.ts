...
export class InscripcionComponent implements OnInit {
  ...
  guardar()
  {
    if (this.inscripcion.validar().esValido)
    {
      ...
      this.db.collection('inscripcion').add(inscripcionAgregar).then((resultado)=>{
        ...
        this.idPrecio ='null';
        this.msj.mensajeCorrecto('Exito', 'Se guardó correctamente');
      });
    }
    else
    {
  ...
  seleccionarPrecio(id: string)
  {
    ...
    if (id!= "null")
    {
      ...
      this.inscripcion.total    = (this.inscripcion.subTotal * 1) + (this.inscripcion.isv * 1);
      ...
      //Esto es para calcular el mes 
      if (this.precioSeleccionado.tipoDuracion == 4) {
        let meses         = this.precioSeleccionado.duracion * 1;
      ...
      //Esto es para calcular el año final
      if (this.precioSeleccionado.tipoDuracion == 5) {
         
        let anios      = this.precioSeleccionado.duracion * 1;
